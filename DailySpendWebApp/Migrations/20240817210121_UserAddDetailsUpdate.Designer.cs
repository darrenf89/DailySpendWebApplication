...
namespace DailySpendWebApp.Migrations
{
    ...
    [Migration("20240817210121_UserAddDetailsUpdate")]
    partial class UserAddDetailsUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailySpendBudgetWebApp.Models.Bills", b =>
                {
                    ...
                    b.Property<decimal>("BillBalanceAtLastPayDay")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DailySpendBudgetWebApp.Models.Budgets", b =>
                {
                    ...
                    b.Property<decimal?>("PlusStashSpendBalance")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DailySpendBudgetWebApp.Models.UserAccounts", b =>
                {
                    ...
                    b.Property<int?>("PreviousDefaultBudgetID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DailySpendWebApp.Models.UserAddDetails", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DailySpendWebApp.Models.UserAddDetails", b =>
                {
                    b.HasOne("DailySpendBudgetWebApp.Models.UserAccounts", "User")
                        .WithMany()
                        .HasForeignKey("UserAccounts")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
