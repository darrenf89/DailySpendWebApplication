        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyPositivePatternRef = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextIncomePaydayCalculated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    StartDayDailyAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartLtSDailyAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    StartLtSPeiordAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    StartBBPeiordAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    StartMaBPeiordAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    EndLtSDailyAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    EndLtSPeiordAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    EndBBPeiordAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    EndMaBPeiordAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    BudgetsBudgetID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhenAdded = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    SavingsSpendType = table.Column<string>(type: "nvarchar(max)", nullable: true),
